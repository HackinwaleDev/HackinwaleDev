...
Backend systems engineer and quantitative developer. I build automated trading systems and strategies, and ship production-grade backend and web solutions.
...
- **Backend and full-stack engineering.** Node.js, Express, Django, ASP.NET, React, Next.js. 6+ years across e-learning, healthcare, business intelligence, fintech and payments, including tech-lead experience.
...
Building an institutional-grade crypto trading system at Innovisie, and researching a market-agnostic strategy to extend it beyond crypto into traditional financial markets. Most production code is private to protect the work, so the public repositories below are older visualization projects and supporting utilities rather than the active strategy code.
